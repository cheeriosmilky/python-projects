...
titlebartitle = Label(titlebar, text='Glactic', bg='#31333D',bd=0,fg='#808080', font=('helvetica', 8, 'bold'), highlightthickness=0)
titlebartitle.pack(side=LEFT, padx=10)
closebutton = Button(titlebar, text='  ×  ', command=root.destroy,bg='#31333D',font=("calibri", 8, 'bold'),bd=0,fg='#808080',highlightthickness=0)
