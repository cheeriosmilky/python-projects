...
# NINJA
# DB NAME = carter_santucci    username: santucci  password: mcctcrocks
# Remote into DB: %
# IP Address: 192.169.144.133
# localhost:3306
# Primary Domain: softwaredevelopment.education
# Database Server from phpMyAdmin: User: cpses_elc4lpge13@localhost
